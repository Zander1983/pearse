define(function (require) {
    ...
    var Backbone            = require('backbone'),
        ...
        NewsLetterCollection = Backbone.Collection.extend({
            ...
            url: function(){
                    if(in_browser===false){
                        return this.feed_domain+'/index.php?option=com_ninjarsssyndicator&feed_id=4&format=raw'
                    }
                    else{
                        return "/school-proxy.php?type=newsletter&feed_domain="+this.feed_domain;
                    }
            },
