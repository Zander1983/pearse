define(function (require) {
    ...
    var Backbone            = require('backbone'),
        ...
        ShoutOutCollection = Backbone.Collection.extend({
            ...
            url: function(){
                    if(in_browser===false){
                        return this.feed_domain+'/index.php?option=com_ninjarsssyndicator&feed_id=17&format=raw'
                    }
                    else{
                        return "/school-proxy.php?type=shoutout&feed_domain="+this.feed_domain;
                    }
            },
